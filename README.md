...
| **ch72** | **Databases for AI apps (pgvector, Redis, vector DBs)** | **Data** |
| glossary | Hindi quick-glossary for data, applied & frontier (136 terms) | Revise |
...
| **ch66** | **Training-data engineering (dedup, licensing, provenance)** | **Frontier** |
